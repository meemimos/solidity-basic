...
contract OperatorTutorial {
    ...
    function booleanOperatorTest(bool foo, bool bar) public pure returns (bool negation, bool conjunction, bool disjunction, bool equality, bool inequality) {
    ...
    function integerOperatorTest(uint x, uint y) public pure returns (uint sum, uint difference, uint product, uint quotient, uint remainder, uint power) {
